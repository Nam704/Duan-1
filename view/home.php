...
<main>
    ...
    <div class="sidebar-menu-wrapper">
            ...
            <ul class="cart_items_list ul_li_block mb_30 clearfix">
                <li>
                    <div class="item_image">
                        <img src="./view/assets/images/cart/img_01.jpg" alt="image_not_found">
                    </div>
        ...
        <div class="sidebar_mobile_menu">
            ...
            <div class="msb_widget brand_logo text-center">
                <a href="index.html">
                    <img src="./view/assets/images/logo/logo_25_1x.png" alt="logo_not_found">
                </a>
            </div>
            ...
            <div class="user_info">
                ...
                <div class="profile_info clearfix">
                    <div class="user_thumbnail">
                        <img src="./view/assets/images/meta/img_01.png" alt="thumbnail_not_found">
                    </div>
    ...
    <section class="slider_section supermarket_slider sec_ptb_50 clearfix"
        data-background="./view/assets/images/backgrounds/bg_13.jpg">
            ...
            <div class="row justify-content-lg-between">
                            ...
                            <div class="card">
                                <ul class="alldepartments_menulist ul_li_block clearfix">
                                    <li>
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_01.png"
                                                    alt="icon_not_found">
                                            </span>
                                    ...
                                    <li>
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_02.png"
                                                    alt="icon_not_found">
                                            </span>
                                    ...
                                    <li>
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_03.png"
                                                    alt="icon_not_found">
                                            </span>
                                    ...
                                    <li class="has_child">
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_04.png"
                                                    alt="icon_not_found">
                                            </span>
                                            Beauty & Health
                                        </a>
                                    ...
                                    <li class="has_child">
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_05.png"
                                                    alt="icon_not_found">
                                            </span>
                                            Women's Fashion
                                        </a>
                                    ...
                                    <li class="has_child">
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_06.png"
                                                    alt="icon_not_found">
                                            </span>
                                    ...
                                    <li class="has_child">
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_07.png"
                                                    alt="icon_not_found">
                                            </span>
                                            Computing & Gaming
                                        </a>
                                    ...
                                    <li class="has_child">
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_08.png"
                                                    alt="icon_not_found">
                                            </span>
                                            Home & Living
                                        </a>
                                    ...
                                    <li class="has_child">
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_09.png"
                                                    alt="icon_not_found">
                                            </span>
                                            Diamond
                                        </a>
                                    ...
                                    <li class="has_child">
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_10.png"
                                                    alt="icon_not_found">
                                            </span>
                                            Men
                                        </a>
                                    ...
                                    <li class="has_child">
                                        <a href="#!">
                                            <span class="icon">
                                                <img src="./view/assets/images/icons/supermarket/icon_11.png"
                                                    alt="icon_not_found">
                                            </span>
                                            Accesories
                                        </a>
                    ...
                    <div class="main_slider clearfix" data-slick='{"arrows": false}'>
                        <div class="item clearfix" data-bg-color="#ffc156">
                            <div class="slider_image order-last" data-animation="fadeInUp" data-delay=".2s">
                                <img src="./view/assets/images/slider/supermarket/img_01.png" alt="image_not_found">
                            </div>
                ...
                <div class="col-lg-3">
                    <div class="sm_offer_item offer_fullimage text-white mb_30">
                        <img src="./view/assets/images/offer/supermarket/img_01.jpg" alt="image_not_found">
                        <div class="item_content">
                    ...
                    <div class="sm_offer_item offer_fullimage text-white mb_30">
                        <img src="./view/assets/images/offer/supermarket/img_02.jpg" alt="image_not_found">
                        <div class="item_content">
                            <h3 class="item_title text-white">
                                Smartphone Bestseller Products 2019
                            </h3>
                    ...
                    <div class="sm_offer_item offer_fullimage text-white">
                        <img src="./view/assets/images/offer/supermarket/img_03.jpg" alt="image_not_found">
                        <div class="item_content">
                            <h3 class="item_title text-white">
                                Smartphone Bestseller Products 2019
                            </h3>
                ...
                <ul class="ul_li clearfix">
                    <li>
                        <div class="supermarket_policy_item clearfix">
                            <div class="item_icon">
                                <img src="./view/assets/images/icons/supermarket/icon_12.png" alt="icon_not_found">
                            </div>
                            <div class="item_content">
                    ...
                    <li>
                        <div class="supermarket_policy_item clearfix">
                            <div class="item_icon">
                                <img src="./view/assets/images/icons/supermarket/icon_13.png" alt="icon_not_found">
                            </div>
                            <div class="item_content">
                    ...
                    <li>
                        <div class="supermarket_policy_item clearfix">
                            <div class="item_icon">
                                <img src="./view/assets/images/icons/supermarket/icon_14.png" alt="icon_not_found">
                            </div>
                            <div class="item_content">
                    ...
                    <li>
                        <div class="supermarket_policy_item clearfix">
                            <div class="item_icon">
                                <img src="./view/assets/images/icons/supermarket/icon_15.png" alt="icon_not_found">
                            </div>
                            <div class="item_content">
                    ...
                    <li>
                        <div class="supermarket_policy_item clearfix">
                            <div class="item_icon">
                                <img src="./view/assets/images/icons/supermarket/icon_16.png" alt="icon_not_found">
                            </div>
                            <div class="item_content">
                ...
                <div class="slideshow5_slider row clearfix" data-slick='{"dots": false}'>
                    <div class="item col">
                        <div class="supermarket_deals_item text-center clearfix">
                            ...
                            <a href="#!" class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_01.png" alt="image_not_found">
                            </a>
                            <div class="item_content">
                                <h3 class="item_title">
                                    <a href="#!"> Baby Shoes </a>
                    ...
                    <div class="item col">
                        <div class="supermarket_deals_item text-center clearfix">
                            <div class="offer_text">Flat -30%</div>
                            <a href="#!" class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_02.png" alt="image_not_found">
                            </a>
                            <div class="item_content">
                                <h3 class="item_title">
                                    <a href="#!"> Baby Shoes </a>
                    ...
                    <div class="item col">
                        <div class="supermarket_deals_item text-center clearfix">
                            <div class="offer_text">Flat -30%</div>
                            <a href="#!" class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_03.png" alt="image_not_found">
                            </a>
                            <div class="item_content">
                                <h3 class="item_title">
                                    <a href="#!"> Baby Shoes </a>
                    ...
                    <div class="item col">
                        <div class="supermarket_deals_item text-center clearfix">
                            <div class="offer_text">Flat -30%</div>
                            <a href="#!" class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_04.png" alt="image_not_found">
                            </a>
                            <div class="item_content">
                                <h3 class="item_title">
                                    <a href="#!"> Baby Shoes </a>
            ...
            <div class="row justify-content-lg-between">
                <div class="col-lg-3">
                    ...
                    <div class="supermarket_advertisement_3">
                        <img src="./view/assets/images/offer/supermarket/img_05.jpg" alt="image_not_found">
                            ...
                            <ul class="supermarket_product_columns has_4columns ul_li clearfix">
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_05.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_06.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_07.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_08.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_09.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_10.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                    ...
                                    <div class="slideshow1_slider" data-slick='{"dots": false}'>
                                        <div class="item">
                                            <div class="supermarket_advertisement_2">
                                                <img src="./view/assets/images/offer/supermarket/img_04.jpg"
                                                    alt="image_not_found">
                                                <div class="item_content">
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./imgs/sanpham1.jfif" alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                            <h3 class="item_title">
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_12.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_13.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_14.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_15.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
                            ...
                            <ul class="supermarket_product_columns has_4columns ul_li clearfix">
                                ...
                                <li>
                                    <div class="supermarket_product_item">
                                        ...
                                        <a class="item_image" href="#!">
                                            <img src="./view/assets/images/shop/supermarket/img_11.png"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <span class="item_type text-uppercase">Speakers</span>
    ...
    <section class="advertisement_section sec_ptb_50 pb-0 clearfix">
        <div class="container maxw_1460">
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="sm_offer_item offer_fullimage text-white">
                        <img src="./view/assets/images/offer/supermarket/img_06.jpg" alt="image_not_found">
                        <div class="item_content">
                            <h3 class="item_title text-white">
                                Smartphone Bestseller Products 2019
                            </h3>
                ...
                <div class="col-lg-4">
                    <div class="sm_offer_item offer_fullimage text-white">
                        <img src="./view/assets/images/offer/supermarket/img_07.jpg" alt="image_not_found">
                        <div class="item_content">
                            <h3 class="item_title text-white">
                                Smartphone Bestseller Products 2019
                            </h3>
                ...
                <div class="col-lg-4">
                    <div class="sm_offer_item offer_fullimage text-white">
                        <img src="./view/assets/images/offer/supermarket/img_08.jpg" alt="image_not_found">
                        <div class="item_content">
                            <h3 class="item_title text-white">
                                Smartphone Bestseller Products 2019
                            </h3>
                    ...
                    <ul class="supermarket_product_columns has_3columns ul_li bg_white clearfix">
                        <li>
                            <div class="supermarket_product_listlayout">
                                <div class="slideshow1_slider item_image" data-slick='{"arrows": false}'>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_16.png"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_16.png"
                        ...
                        <li>
                            <div class="supermarket_product_listlayout">
                                <div class="item_image">
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_18.png"
                                            alt="image_not_found">
                                    </div>
                        ...
                        <li>
                            <div class="supermarket_product_listlayout">
                                <div class="slideshow1_slider item_image" data-slick='{"arrows": false}'>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_17.png"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_17.png"
                        ...
                        <li>
                            <div class="supermarket_product_listlayout">
                                <div class="slideshow1_slider item_image" data-slick='{"arrows": false}'>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_19.png"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_19.png"
                        ...
                        <li>
                            <div class="supermarket_product_listlayout">
                                <div class="slideshow1_slider item_image" data-slick='{"arrows": false}'>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_20.png"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_20.png"
                        ...
                        <li>
                            <div class="supermarket_product_listlayout">
                                <div class="slideshow1_slider item_image" data-slick='{"arrows": false}'>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_21.png"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item">
                                        <img src="./view/assets/images/shop/supermarket/img_21.png"
    ...
    <section class="advertisement_section sec_ptb_50 clearfix">
        <div class="container maxw_1460">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="sm_offer_item offer_fullimage text-white">
                        <img src="./view/assets/images/offer/supermarket/img_09.jpg" alt="image_not_found">
                        <div class="item_content">
                            <h3 class="item_title text-white">
                                Smartphone Bestseller Products 2019
                            </h3>
                ...
                <div class="col-lg-6">
                    <div class="sm_offer_item offer_fullimage text-white">
                        <img src="./view/assets/images/offer/supermarket/img_10.jpg" alt="image_not_found">
                        <div class="item_content">
                            <h3 class="item_title text-white">
                                Smartphone Bestseller Products 2019
                            </h3>
            ...
            <div class="container maxw_1460">
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-7 order-last">
                        <div class="item_image">
                            <img src="./view/assets/images/feature/supermarket/img_01.png" alt="image_not_found">
                        </div>
                    </div>
            ...
            <div class="row justify-content-lg-between">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="bestseller_wrap">
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_22.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_13.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_16.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="bestseller_wrap">
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_11.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_19.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_21.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="bestseller_wrap">
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_23.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_24.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
                        ...
                        <div class="supermarket_product_small">
                            <div class="item_image">
                                <img src="./view/assets/images/shop/supermarket/img_06.png" alt="image_not_found">
                                <ul class="product_label ul_li_block clearfix">
                                    <li data-bg-color="#cc1414">-70%</li>
                                </ul>
                            </div>
