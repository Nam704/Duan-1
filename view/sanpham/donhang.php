...
<section class="checkout_section sec_ptb_140 clearfix">
    <div class="container">
        ...
        <ul class="checkout_step ul_li clearfix">
            <li><a href="index.php?act=muahang"><span>01.</span> Shopping Cart</a></li>
            <li class="active"><a href="index.php?act=checkout"><span>02.</span> Checkout</a></li>
                            ...
                            <form action="#">
                                ...
                                <div class="login_button">
                                    <div class="checkbox_item">
                                        <label for="remember_checkbox"><input id="remember_checkbox" type="checkbox">
                                            Remember me</label>
                                    </div>
