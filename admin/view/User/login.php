                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="p-4 my-auto">
                                        ...
                                        <form action="../index.php?act=dangnhap" method="post">
                                            <div class="mb-3">
                                                <label for="emailaddress" class="form-label">Tên người dùng</label>
                                                <input class="form-control" type="text" name="username"
                                                    id="emailaddress" required="" placeholder="Enter your name">
                                            </div>
                                            <div class="mb-3">
                                                <a href="./quenmatkhau.php" class="text-muted float-end"><small>Forgot
                                                        your
                                                        password?</a>
                                                <p style="color: red;">
                                                    </small><?php
