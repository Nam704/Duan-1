var colors = ["#3bc0c3"],
  ...
  options = {
    ...
    colors: (colors = dataColors ? dataColors.split(",") : colors),
    series: [
      { name: "Series 1", data: [40, 60, 44, 84, 64, 110, 95] },
      { name: "Series 2", data: [20, 30, 22, 42, 32, 55, 44] },
    ],
    legend: { offsetY: 5 },
  ...
  options = {
    ...
    series: [
      { name: "Series 1", data: [45, 60, 41, 64, 22, 43, 21] },
      { name: "Series 2", data: [42, 40, 33, 52, 13, 44, 32] },
    ],
...
var colors = ["#3bc0c3", "#47ad77", "#fa5c7c", "#39afd1"],
  ...
  options = {
    ...
    colors: (colors = dataColors ? dataColors.split(",") : colors),
    series: [
      { name: "Net Profit", data: [82, 50, 55, 42, 45, 48, 52, 53, 41] },
      { name: "Revenue", data: [60, 42, 82, 62, 61, 58, 63, 60, 66] },
