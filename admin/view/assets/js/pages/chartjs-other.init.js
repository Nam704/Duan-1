...
!(function (a) {
  ...
  (t.prototype.bubbleExample = function () {
    var t = document.getElementById("bubble-example"),
    ...
    (t.prototype.donutExample = function () {
      var t = document.getElementById("donut-example"),
        e = t.getAttribute("data-colors"),
        e = e ? e.split(",") : this.defaultColors,
        t = t.getContext("2d"),
        t = new Chart(t, {
    ...
    (t.prototype.radarExample = function () {
      var t = document.getElementById("radar-example"),
        e = t.getAttribute("data-colors"),
        e = e ? e.split(",") : this.defaultColors,
        t = t.getContext("2d"),
        t = new Chart(t, {
    ...
    (t.prototype.scatterExample = function () {
      var t = document.getElementById("scatter-example"),
        e = t.getAttribute("data-colors"),
        e = e ? e.split(",") : this.defaultColors,
        t = t.getContext("2d"),
        t = new Chart(t, {
    ...
    (t.prototype.barLineExample = function () {
      var t = document.getElementById("bar-line-example"),
        e = t.getAttribute("data-colors"),
        e = e ? e.split(",") : this.defaultColors,
        t = t.getContext("2d"),
        t = new Chart(t, {
