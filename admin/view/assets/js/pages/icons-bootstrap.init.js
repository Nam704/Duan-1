class BootstrapIcons {
  initBootstrap() {
    const e = document.getElementById("bootstrap-icons");
    if (e) {
      const i = this;
      e &&
        [
  ...
  getIconItem(l) {
    const e = document.createElement("div"),
      i =
        ((e.className = "col-xl-3 col-lg-4 col-sm-6"),
        document.createElement("div")),
      a =
        (i.classList.add("icon-item"),
        (i.style.display = "flex"),
        (i.style.alignItems = "center"),
        document.createElement("i")),
      r =
        ((a.className = "bi bi-" + l),
        a.classList.add("me-3"),
        a.classList.add("fs-20"),
        i.appendChild(a),
